...
const BasicList: React.FunctionComponent<BasicListProps> = (props: BasicListProps): JSX.Element => {
    ...
    const renderOptions = (id, validFlag, verifyFlag, record) => {
        if (isManager) {
            ...
            return (
                <div >
                    <Button type="primary" size={isPhone ? "small" : "medium"} onClick={openJoinDialog.bind(this, id)}>参与招标</Button>
                    <Dialog
                        visible={joinVisible}
                        title="申请参与招标"
                        style={{ width: '500px' }}
                                ...
                                <div className={styles.main}>
                                    <div className={styles.left}>
                                        <div>
                                            ...
                                            {isPhone ? "" : <><div className={styles.content}> 招标简介：{c.content}
                                                                </div>
